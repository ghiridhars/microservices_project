...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(ProducerMicroserviceException.class)
	public ResponseEntity<String> handleFetchException(ProducerMicroserviceException fe, WebRequest wr,Model m) {
